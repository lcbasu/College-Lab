...
<body>
<h1>Enter Electrical Department Password</h1>
<p>&nbsp;</p>
<p><a href="index.php">Main Menu</a></p>
<p>&nbsp;</p>
<form id="form1" name="form1" method="post" action="elecPasswordCheck.php">
  <p>
    <label for="electricalDepttPasswrd">Enter Electrical Department Password</label>
    <input type="password" name="electricalDepttPasswrd" id="electricalDepttPasswrd" />
  </p>
  <p>
