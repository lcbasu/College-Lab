...
$query_Recordset1 = sprintf("SELECT * FROM complain_info WHERE personID = %s ORDER BY complainTime ASC", GetSQLValueString($colname_Recordset1, "int"));
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $ec451_conn) or die(mysql_error());
...
<p>All your complaints:</p>
<table width="1200">
  <tr id="tableHeader">
    <th scope="col">Complain Number</th>
    <th scope="col">Complain Type</th>
    <th scope="col">Complain Description</th>
    <th scope="col">Complain TimeStamp</th>
    <th scope="col">Complain Status</th>
  </tr>
  <?php do { ?>
    <tr>
      <td><?php echo $row_Recordset1['complainNo']; ?></td>
      <td><?php echo $row_Recordset1['complainType']; ?></td>
      <td><?php echo $row_Recordset1['complainDescr']; ?></td>
      <td><?php echo $row_Recordset1['complainTime']; ?></td>
      <td><?php echo $row_Recordset1['complainStatus']; ?></td>
    </tr>
