...
<body>
<h1>Enter Water Department Password</h1>
<p>&nbsp;</p>
<p><a href="index.php">Main Menu</a></p>
<p>&nbsp;</p>
<form id="form1" name="form1" method="post" action="waterPasswordCheck.php">
  <p>
    <label for="waterDepttPasswrd">Enter Water Department Password</label>
    <input type="password" name="waterDepttPasswrd" id="waterDepttPasswrd" />
  </p>
  <p>
